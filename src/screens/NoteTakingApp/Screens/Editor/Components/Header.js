...
const Header = ({navigation,mode,data}) => {
  ...
  return (
    <View style={styles.header}>
      <BackStopModel visible={model} setVisible={setModel} navigation={navigation}  />
      <SaveModel visible={model2} setVisible={setmodel2} navigation={navigation} />
      <Pressable
    ...
    <View style={styles.CardContet}>
     ...
     { mode ==="edit" && <Pressable style={[styles.Listbtn]} onPress={()=>{
        setmodel2(!model2)
      }}>
     <SaveBtn width={wp(2.5 * 2.4)} height={wp(2.5 * 2.4)} color={NoteAppcolor.Primary}/>
      </Pressable>}

      
    { mode=== "view" &&<Pressable style={[styles.Listbtn, {backgroundColor:null}]}>
