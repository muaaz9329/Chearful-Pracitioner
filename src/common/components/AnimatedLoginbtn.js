 ...
 */
const AnimatedLoginBtn = ({ HandleFunc , ReducerAction , Text}) => {

    

    const { loading ,Success , error} = useSelector((state) => state[ReducerAction]); // consist of State that tells Weather the user is logged in or not , have a loading state and a error state and a success state
